...
can be share with other team members and start to collaborate on differente tickets.
...
Upstream is the standar name that we use to refer to the "central" repository
which is the one that have the functional code and everyone make a fork from.

## Fork

This is a "copy" of the central repository. It's going to be under your user 
name. You have to be aware that all the changes made in the upstream repository
are not going to appear automatically in your fork.
