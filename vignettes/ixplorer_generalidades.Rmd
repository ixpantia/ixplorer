...
a la información desde el servicio  ixplorer de forma rápida ysencilla desde RStudio.
Esto significa que puede ver los tiquetes asignados a usted o 
a su equipo mientras escribe código, así como todos los tiquetes de tu repositorio
...
* obtener un tibble con los boletos abiertos y cerrados de un repo con
