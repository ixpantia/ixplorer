  ...
  server <- function(input, output, session) {
    ...
    observeEvent(input$create, {
      ...
      tryCatch(1, finally = print("Hello"))
        ...
        # "No se ha creado ningún tiquete debido a credenciales inválidas. Porfavor use el gadget de autentificación."
        )
      stopApp(NULL)
    })
  }
